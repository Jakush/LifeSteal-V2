...
public class HealthManagerTab implements TabCompleter {
	...
	public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
		...
		if (args.length == 1) {
			return StringUtil.copyPartialMatches(args[0], Arrays.asList("author","help","reload","spigotmc","set","send","recipe","showRecipe","ver","version","revive","editRecipe","edit"), tab);
		}
		if (args.length == 2) {
